       ...
       <div>
          <Container>
              ...
              <>
                    ...
                    <a className="mt-4 text-decoration-none"  href={singleArticle.url}><p className="text-start">Click here to read the entire article from {singleArticle.news_site}</p></a>
              </>
                }
          </Container>
       </div>
